# WTIS 선정검증: Secure AI (v3 — reinforcement loop)

---
date: 2026-02-26
wtis_skill: SKILL-1
version: v3 (reinforcement loop)
confidence: Medium
status: completed
analyst: WTIS SKILL-1 (feasibility assessor)
input_sources:
  - 2026-02-26_wtis-proposal-secure-ai-skill0.md (SKILL-0)
  - 2026-02-26_wtis-proposal-secure-ai-research-v2.md (research-deep v2 + 부록 v2.1 보강)
  - scoring-framework.md
---

## 경영진 요약

> **판정: Conditional Go | 총점: 123/200 | 신뢰도: Medium**
>
> Secure AI(B2C 통화 보안) 과제는 보이스피싱 피해액 1조 2,578억 원(2025년) [N-04, N-10]이라는 명확한 시장 명분과, 온디바이스 AI 딥페이크 탐지(TRL 7~8) [E-04, P-09]의 기술 기반을 갖추고 있다. 그러나 제안서의 핵심 기술 조합인 "양자암호 + 동형암호 + OndeviceAI 3중 보안"에서 동형암호(HE)의 실시간 통화 적용이 현재 기술로 불가능하다는 critical risk가 확인되었고 [P-01, P-02, P-05], 삼성 갤럭시 S26(2026년 3월)의 OS 레벨 무료 보이스피싱 탐지 [E-01]와 정부-통신 3사 공동 플랫폼(2026~2027) [E-01]이 독자 유료 서비스의 차별화 공간을 급격히 축소시킨다. **HE를 제외하고 PQC E2E 암호화 통화 + 프라이버시 보존 온디바이스 탐지(SafeEar 아키텍처 [P-08])로 기술 조합을 재설계할 경우**, 니치 프리미엄 시장(고보안 수요 고객)과 금융-통신 연계 B2B 모델(익시오-KB국민은행 확장 [E-04])에서 Conditional Go가 가능하다. 3B 전략: Build(온디바이스 탐지 고도화) + Borrow(PQC 네트워크 통합). v3에서는 validator v2 지적사항(고아 인용 5건, 미인용 수치 3건, 단일 소스 4건)을 전면 보강하여 인용 품질을 개선했다. 데이터 부족 항목이 3개로 감소하여 신뢰도를 Medium으로 유지한다.
...
| **Achievable** | **기술 조건부** — 온디바이스 AI 탐지는 TRL 7~8로 즉시 실현 가능 [E-04, P-09]. PQC 통화 암호화는 TRL 5~6 파일럿 단계 [G-07, G-08]. **동형암호 실시간 적용은 불가** [P-01, P-02, P-05]. 3중 조합 중 HE 제외 시 실현 가능. | HE: TFHE per-gate 13ms [P-01] × 수백~수천 게이트 = 수초 이상 누적, ITU-T G.114 편도 지연 150ms 기준 [G-22] 대비 불가 |
| **Relevant** | **충족** — LG U+ '보안퍼스트' 전략 [I-01], Exy Guardian 스위트(Anti-DeepVoice+PQC+SLM) MWC 2025 발표 [E-05]와 직접 연계. 보이스피싱 피해 1조 원 돌파 [N-04]로 사회적 긴급성 확인. PQC가 2026년 핵심 사이버보안 축으로 전환되고 있어 [G-15] 기술 방향성과도 정합. | LG U+ Exy Guardian: Anti-DeepVoice + PQC + On-Device SLM [E-05] |
...
- **교차 확인**: DataIntelo 독립 보고서(AI-Powered Voice Fraud Detection: $2.36B(2024), CAGR 18.7%)로 교차 확인 [G-14, G-16]. 복수 리서치 기관이 14~20% CAGR 범위에서 일관된 성장률을 제시하여 시장 성장 방향 확인 [B].
- **Counter-argument**: 글로벌 시장 규모는 B2B Contact Center 중심. B2C 통화 보안은 이 시장의 하위 세그먼트이며, 별도 규모 추정이 필요하나 공개 데이터 부재.

**SAM (Serviceable Available Market):**

- **국내 보이스피싱 피해**: 1조 2,578억 원(2025년) [N-04, N-10]. 경찰청 통합대응단 및 금감원 정책보고서 [N-11]로 다년간 추이 완전 검증. 이 피해액이 "방지 서비스" 수요의 근거.
- **국내 이동통신 가입자**: 약 5,724만 회선(2025년 5월 기준, MSIT 공식 통계) [G-20]. LG U+ 점유율 19.5% = 약 1,113만 회선 [G-20].
...
- 제안서 미지정. 에이전트 추정: LG U+ 가입자 1,113만 회선 [G-20] 중 프리미엄 유료 전환율 1~3% 가정 시 11.1만~33.4만 명. 월 1,000~3,000원 가정 시 연간 약 133억~1,200억 원 범위.
...
| 기술 | TRL | 파괴성 | 사분면 | 근거 |
|------|-----|--------|--------|------|
| 온디바이스 AI 딥페이크 탐지 | 7~8 | High | **[베팅]** | 국내 3사+삼성 상용화 완료 [E-01~E-04]. 159k 파라미터 경량 모델 학술 검증 [P-09]. 딥페이크 탐지 성능에 입력 표현 방식이 핵심적으로 영향하며 [P-07], 서비스 구현 시 전처리 파이프라인 설계가 중요. |
| SafeEar 프라이버시 보존 탐지 | 6~7 | High | **[베팅]** | ACM CCS 2024 peer-reviewed, EER 2.02% [P-08]. 프라이버시 차별화 기회. |
| PQC 알고리즘 (ML-KEM 등) | 7~8 | Medium | **[유지]** | NIST 표준 확정 [G-07], GSMA PQ.03 v2.0 가이드라인 [G-08]. PQC가 2026년 핵심 사이버보안 축으로 전환 확인 [G-15]. 파괴성은 장기적. |
...
| 동형암호 (HE) 실시간 통화 | 2~3 | High | **[탐색]** | TFHE per-gate 13ms [P-01] × 수백~수천 게이트 = 수초 이상 누적, ITU-T G.114 편도 지연 150ms 기준 [G-22] 초과. 최적화된 TFHE 조건에서도 4.2~6.8ms/operation으로 [P-03], 음성 스트림 처리에는 수천 게이트 필요하므로 누적 지연 불가피. 클라우드 지원 시 E2E HE 오디오 가능하나 전용 프로토콜 필요, 일반 VoLTE 즉시 적용 불가 [P-04]. "prohibitive latency" 명시 [P-05, P-06]. VoIP HE 개념은 이미 2015년 선행특허 [T-05]가 존재하나 실용화에 이르지 못한 역사적 맥락. |
...
|------------|----------------|-------|----------|---------|------------|--------|
| **SKT** | 스캠뱅가드 + 에이닷 전화 (온디바이스 AI) | 상용화, 연간 11억 건 차단 | 2024~2025 상용 | PQC SIM(Thales 협력) 실증 [I-01] | 5년 7,000억 원 보안 투자 [N-12, N-13] | [E-02, N-01] |
| **KT** | AI 보이스피싱 탐지 2.0 (화자인식+딥보이스) | 상용화, 탐지율 91.6% | 2025년 7월 출시, 목표 95%+ | ICT 규제샌드박스 승인 [N-09] | 5년 1조 원 보안 투자 [N-14, N-15] | [E-03, N-09] |
...
| 동형암호 (HE) | **Watch** (투자 보류) | Low (2/10) | - | Low | ITU-T G.114 편도 지연 150ms 기준 [G-22] 대비, TFHE per-gate 13ms [P-01] × 수백~수천 게이트 = 수초 이상 누적으로 실시간 통화 불가 [P-01, P-02, P-05]. Samsung HE 가속 칩 특허 [T-02] 동향만 모니터링. 3~5년 후 재평가. |
...
1. **시장 명분 강력**: 보이스피싱 피해 1조 2,578억 원(2025년) [N-04, N-10], 2024년 +335% 폭증 [N-03]. 사회적·정책적 긴급성 확인 [E-01].
...
| 구분 | 내용 | 출처 |
|------|------|------|
| Pain Point 심각도 | 보이스피싱 피해액 2025년 1조 2,578억 원 [N-04, N-10], 1인당 5,290만 원. 2024년 대비 +47%. 2023년 금감원 통계 1,965억 원(+35.4% YoY) [N-11]에서 구조적 전환 확인. 악성 앱 장악형 신종 수법 확산. | [N-04, N-03, N-10, N-11] |
...
| 구분 | 내용 | 출처 |
|------|------|------|
| 글로벌 시장 규모 | 음성 사기 분석: $1.87B(2024) → $5.49B(2033), CAGR 14.2% [G-14]. DataIntelo 교차 확인: $2.36B(2024), CAGR 18.7% [G-16]. 아태 CAGR 16.8%. | [G-14, G-16] |
| 국내 피해 규모 (수요 근거) | 2025년 1조 2,578억 원 [N-04, N-10]. 2022~2025 연평균 성장률 +100%+. 경찰청·금감원 공식 통계로 완전 검증 [N-10, N-11]. | [N-04, N-10, N-11] |
...
| PQC TRL | 알고리즘 TRL 7~8. VoLTE 통합 TRL 5~6. 단말 E2E TRL 4~5. PQC가 2026년 핵심 사이버보안 축으로 전환 확인 [G-15]. | [G-07, G-08, I-01, G-15] |
| HE TRL (실시간 통화) | TRL 2~3. **불가 판정.** TFHE per-gate 13ms [P-01] × 수백~수천 게이트 = 수초 이상 누적, ITU-T G.114 편도 지연 150ms 기준 [G-22] 초과. 최적화된 TFHE에서도 4.2~6.8ms/operation [P-03], 음성 스트림에 수천 게이트 필요하므로 누적 지연 불가피. 클라우드 지원 E2E HE 오디오는 전용 프로토콜 필요, 일반 VoLTE 즉시 적용 불가 [P-04]. "prohibitive latency" 명시 [P-05]. | [P-01, P-02, P-03, P-04, P-05, G-22] |
| 학술 기반 | SafeEar EER 2.02% [P-08], 경량 모델 159k params EER 0.16% [P-09] — 온디바이스 배포 학술 검증 완료. | [P-08, P-09] |
| 특허 포트폴리오 | Google 보이스피싱 탐지 [T-01], Samsung HE 가속 [T-02], VoIP HE 선행특허(2015) [T-05] 등 해외 선행 특허 존재. **LGU+ 국내 특허 현황 미확인** — KIPRIS 검색 필요. | [T-01, T-02, T-05] |
...
| 세부 지표 | 점수 | 근거 |
|----------|------|------|
| Pain Point 심각도 | **9/10** | 2025년 피해 1조 2,578억 원, 1인당 5,290만 원 [N-04, N-10]. 2024년 +335% 폭증 [N-03]. 사회적 긴급성 최고 수준. |
...
| 세부 지표 | 점수 | 근거 |
|----------|------|------|
| 시장 규모 TAM/SAM/SOM | **6/10** | 글로벌 TAM $1.87B [G-14], DataIntelo 교차 확인 $2.36B [G-16]. 국내 B2C 유료 TAM 데이터 부재 [D]. 피해액 1조 원이 수요 근거이나, "수요=유료 시장"은 아님. |
| 성장률 CAGR | **8/10** | 글로벌 CAGR 14.2% [G-14], DataIntelo 18.7% [G-16], 아태 16.8% [G-14]. 복수 독립 리서치 기관이 14~20% CAGR 범위에서 일관된 성장률 제시. 국내 피해액 2022~2025 연평균 +100%+로 수요 급증 [N-04, N-10, N-11]. |
...
| 특허 포트폴리오 | **5/10** (데이터 부족) | LGU+ 국내 특허 포트폴리오 미확인. Google [T-01], Samsung [T-02], VoIP HE 선행특허 [T-05] 등 해외 선행 특허 존재. KIPRIS 검색 필요. 보강 키워드: `"LG유플러스 보이스피싱 탐지 특허"`, `"KIPRIS 양자암호 통화 보안 특허"` |
...
| 경쟁사 대응력 | **4/10** | SKT 7,000억 원 [N-12], KT 1조 원 [N-14] 보안 투자 — LGU+와 동등~우위. 삼성 S26 OS 레벨 무료 선점 [E-01]. 경쟁사 대응 속도 빠름. |
...
| ~~D-4~~ | ~~PQC/SafeEar 차별화 지속 기간~~ | (v3에서 유지: 데이터 부족이나 핵심 판정에 영향 없음) | 5/10 (중앙값) | `"PQC telecom deployment timeline competitor"`, `"양자내성암호 통신사 상용화 일정"` |
| ~~D-5~~ | ~~투자 규모 대비 ROI~~ | (v3에서 유지: 데이터 부족이나 핵심 판정에 영향 없음) | 5/10 (중앙값) | `"telecom voice security service ROI"`, `"통화보안 서비스 투자수익률 사례"` |
| ~~D-6~~ | ~~12~18개월 서비스 출시 타임라인 근거~~ | (v3에서 유지: 데이터 부족이나 핵심 판정에 영향 없음) | - (추정 표시) | `"telecom voice security service launch timeline"`, `"통신사 보안서비스 출시 일정 사례"` |

**v3 보강 결과:**
- **해소된 항목**: 글로벌 시장 규모 교차 확인(G-14+G-16 → [B]로 상향), 보이스피싱 통계 복수 소스(N-04+N-10+N-11 → [A]), SKT/KT 투자 외부 소스(N-12~N-15 → [A]), 이동통신 가입자 수 MSIT 공식(G-20 → [A]), 통화 지연 기준값 ITU-T G.114(G-22 → [A])
- **잔존 데이터 부족 항목**: D-1(국내 B2C 유료 TAM), D-2(WTP), D-3(LGU+ 특허) = **3개**

**데이터 부족 항목 3개 (≤3개) → 신뢰도 Medium 기준 충족. 핵심 기술 판정(HE 불가, 온디바이스 TRL 7~8)은 복수 학술 소스로 High 확신 수준이므로 Medium 유지.**
...
- **High 확신 영역**: 동형암호 실시간 불가 판정(복수 학술 논문 [P-01, P-02, P-03, P-04, P-05] + IEEE 실증 [P-02]), 보이스피싱 피해 통계(경찰청·금감원 공식 [N-03, N-04, N-10, N-11]), 삼성 S26/iOS 26 무료 탑재(공식 발표 [E-01, N-07]), 온디바이스 AI TRL 7~8(3사+삼성 상용화 [E-01~E-04]), 이동통신 가입자 5,724만 회선(MSIT 공식 [G-20]), SKT 7,000억 원/KT 1조 원 투자(공식 발표 [N-12, N-14]), 통화 지연 기준 ITU-T G.114 150ms [G-22]
- **Medium 확신 영역**: 글로벌 시장 규모 $1.87B(GrowthMarketReports [G-14] + DataIntelo [G-16] 교차 확인), KT 탐지율 91.6%(KT 뉴스룸+Telecompaper 2개 소스 [E-03]), LGU+ 익시오 피해 예방 1,720억 원(복수 언론 [E-04])
- **Low 확신/데이터 부재 영역**: 국내 B2C 유료 TAM [D-1], WTP [D-2], LGU+ 특허 포트폴리오 [D-3]
- **데이터 부족 항목 3개**: v2의 6개에서 3개로 감소. 규칙상 3개 이하 시 자동 Medium 가능. 핵심 기술 판정과 경쟁사 현황은 High 확신이므로 Medium 유지.
...
| G-17 | DataIntelo | 2024 | 리서치 | Call Center Fraud Detection AI Market | $1.92B(2024)→$8.60B(2033), CAGR 19.7% | 3 | 3 | 4 | https://dataintelo.com/report/call-center-fraud-detection-ai-market |
| G-18 | Market Research Future | 2024 | 리서치 | Voice Analytics Market (광의) | $3.69B(2024)→$13.73B(2035), CAGR 12.68% | 3 | 3 | 4 | https://www.marketresearchfuture.com/reports/voice-analytics-market |
| G-19 | Allied Market Research | 2023 | 리서치 | Voice Analytics Market | $1.3B(2023)→$6.7B(2032), CAGR 19.6% | 3 | 3 | 4 | https://www.alliedmarketresearch.com/voice-analytics-market |
| G-20 | 서울신문 (MSIT 공식 통계 기반) | 2025.07.18 | 정부/미디어 | SKT 시장 점유율 40% 무너졌다 | 이동통신 휴대폰: SKT 2,249.9만(39.3%), KT 1,361.1만(23.8%), LGU+ 1,113.1만(19.5%), MVNO 999.8만(17.5%) / 합계 5,723.8만 회선 | 5 | 5 | 5 | https://www.seoul.co.kr/news/ |
| G-21 | MSIT 무선통신서비스 통계 | 2025.07 | 정부 | 무선통신서비스 가입자 통계 | 전체 무선회선(IoT 포함): 9,079만 회선 | 3 | 5 | 5 | https://www.msit.go.kr/ |
| G-22 | ITU-T Rec. G.114 | 2009 (국제표준) | 국제기구 | One-way Transmission Time | End-to-end 편도 지연: 0~150ms 권장, 150~400ms 허용 | 5 | 5 | 5 | https://www.itu.int/rec/T-REC-G.114/ |
| G-23 | Cisco | - | 기업 | Understanding Delay in Packet Voice Networks | 실무: 200ms 적정, 250ms 한계. 지연 분해: codec 2.5~10ms, packetization 20~30ms, network 가변 | 4 | 4 | 4 | https://www.cisco.com/c/en/us/support/docs/voice/voice-quality/5125-delay-details.html |
...
| N-10 | 뉴시스 (경찰청 통합대응단) | 2025.11.24 | 보이스피싱 피해 1조원 돌파 | 보이스피싱 피해 경찰청 2025 | 2025년 1~10월: 1조 566억 원(1만 9,972건), 2024년 연간: 1조 2,578억 원 확정 | https://www.newsis.com/ |
| N-11 | 금융감독원 | 2024.03 | 2023년 보이스피싱 피해현황 분석 | 금감원 보이스피싱 피해현황 2023 | 2023년: 1,965억 원(+35.4% YoY), 1인당 1,710만 원 | https://www.fss.or.kr/ |
| N-12 | 네이트 뉴스 (경찰청 조사결과 발표) | 2025.07.04 | SKT 5년간 7,000억 원 보안 투자 | SKT 보안 투자 7000억 | SKT 유영상 대표: 5년간 7,000억 원 투자 공식 발표 (유심 해킹 사태 후속) | https://news.nate.com/ |
| N-13 | 보안뉴스 | 2025.07.04 | SKT CISO CEO 직속 격상 | SKT 보안 투자 CISO | SKT CISO CEO 직속 격상, 보안 인력 2배 확대 | https://www.boannews.com/ |
| N-14 | 네이트 뉴스 (KT 브리핑) | 2025.07.15 | KT 5년간 1조 원 보안 투자 | KT 보안 투자 1조 | KT 5년간 1조 원 투자 공식 발표 (연 평균 약 2,000억 원) | https://news.nate.com/ |
| N-15 | 서울경제 | 2025.07.15 | KT 보안 인력 162명에서 300명으로 | KT 보안 인력 확대 | KT 보안 인력 162명→300명, AI 기반 선제 보안 | https://www.seoul.co.kr/ |
...
### v2 → v3 수정 내역 (reinforcement loop)

| 항목 | v2 상태 | v3 수정 | 근거 |
|------|---------|---------|------|
| **G-15 고아 인용** | References에만 존재, 본문 미인용 | 1.1절 Relevant 행 + 2절 배치 근거 PQC 행 + 기술경쟁력 PQC TRL에서 인용 | validator v2 지적 |
| **P-03 고아 인용** | References에만 존재, 본문 미인용 | 2절 HE 행 + 기술경쟁력 HE TRL에서 인용: "최적화된 TFHE에서도 4.2~6.8ms/operation [P-03]" | validator v2 지적 |
| **P-04 고아 인용** | References에만 존재, 본문 미인용 | 2절 HE 행 + 기술경쟁력 HE TRL에서 인용: "클라우드 지원 E2E HE 오디오 가능하나 전용 프로토콜 필요 [P-04]" | validator v2 지적 |
| **P-07 고아 인용** | References에만 존재, 본문 미인용 | 2절 배치 근거 온디바이스 행에서 인용: "딥페이크 탐지 성능에 입력 표현 방식이 핵심 [P-07]" | validator v2 지적 |
| **T-05 고아 인용** | References에만 존재, 본문 미인용 | 2절 HE 행 + 기술경쟁력 특허 포트폴리오에서 인용: "VoIP HE 선행특허(2015) [T-05]" | validator v2 지적 |
| **가입자 7,400만** | 출처 없는 수치 | 5,724만 회선(MSIT 공식) [G-20]으로 수정. LGU+ 1,113만 회선. SOM 재계산: 133억~1,200억 원 | MSIT 공식 통계 |
| **<20ms 실시간 요건** | 출처 없는 기준값 | ITU-T G.114 편도 지연 150ms [G-22]로 교체. HE 불가 논리 재구성 | ITU-T 국제표준 |
| **+335% 폭증 인용 누락** | 5절 핵심 근거 1번에서 [N-03] 미인용 | [N-03] 인용 추가 | validator v2 지적 |
| **글로벌 TAM 단일 소스** | G-14만 의존, "독립 교차 확인 소스 부재 [C]" | G-14 + G-16(DataIntelo) 복수 소스. 신뢰도 [C]→[B] | 보강 v2.1 |
| **보이스피싱 통계 단일 소스** | N-04만 의존 | N-04 + N-10(뉴시스/경찰청) + N-11(금감원) 복수 인용 | 보강 v2.1 |
| **SKT/KT 투자 내부 소스** | I-01만 의존 | N-12/N-13(SKT 공식) + N-14/N-15(KT 공식) 외부 소스 추가 | 보강 v2.1 |
| **성장률 CAGR 점수** | 7/10 (단일 소스 [C]) | **8/10** (복수 독립 소스 교차 확인 [B]) | 시장 교차 검증 개선 |
| **총점** | 122/200 | **123/200** (시장매력도 26→27) | 성장률 1점 상향 |
| **데이터 부족 항목** | 6개 | **3개** (글로벌 시장·보이스피싱·투자·가입자·지연 해소) | 보강으로 감소 |
| **신규 References** | - | G-16~G-23 (8개), N-10~N-15 (6개) 추가 | 보강 v2.1 |

---

*본 보고서는 WTIS v4.0 파이프라인의 SKILL-1(선정검증) 단계 산출물이다. v3에서 validator v2 지적사항(고아 인용 5건, 미인용 수치 3건, 단일 소스 4건)을 전면 보강했다. 최종 의사결정은 경영진의 판단에 위임한다.*